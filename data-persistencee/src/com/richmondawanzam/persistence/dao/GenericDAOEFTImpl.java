...
import com.richmondawanzam.persistence.core.EMFEFT;



public abstract class GenericDAOEFTImpl<T, ID extends Serializable> implements GenericDAO<T, ID>, Serializable {
...
//		log.debug(GenericDAOImpl.class.getSimpleName(), "GenericDAOImpl()", "entityClass "+ this.entityClass.getName());
	...
	public T findById(ID id) {
		EntityManager em = EMFEFT.createEntityManagerEft();
...
//		log.debug(GenericDAOImpl.class.getSimpleName(), "findAllFilteredWithPagingNative", "QueryName : " + queryName + " params [" + Arrays.toString(params) + "]");
	...
	public boolean isManaged(){
		return EMFEFT.createEntityManagerEft().contains(getEntityClass());
	}
